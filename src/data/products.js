...
export const products = [
  ...
  // SPEAKERS
  {
    ...
    features:
      "Connect via Bluetooth or nearly any wired source. This speaker features optical, digital coaxial, USB Type-B, stereo RCA, and stereo XLR inputs, allowing you to have up to five wired source devices connected for easy switching. Improved bluetooth technology offers near lossless audio quality at up to 328ft (100m).\n\nDiscover clear, more natural sounding highs than the competition with ZX9's signature planar diaphragm tweeter. Equally impressive is its 8.5\" woofer with a 2-tone ultrarigid fiberglass diaphragm and a superb full-range crossover to give your music the mellow bass you would expect. You'll experience new sensations from the full-range deep bass that's engineered to harmonize perfectly with ZX9's detailed mid-range. Spanning a wide performance area, this speaker is the perfect match for any sound waves.",
    includes: [
